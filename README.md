...
# The result of the opt() function can be used as the initial value too, but due to initial value sensitivity, it may be necessary to add control_gradient_con and noncollocation_point_error_con gradually
